export const onRequestPost = async (context) => {
  ...
  await fetch(
    `https://graph.microsoft.com/v1.0/sites/tsc1907.sharepoint.com:/sites/Bosseln:/lists/Teams/items/${body.teamId}/fields`,
    {
      method: "PATCH",
      headers: {
      ...
      body: JSON.stringify({
        LetztePositionLat: body.lat,
        LetztePositionLng: body.lng
      })
    }
  );
